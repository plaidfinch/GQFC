...
You may also want to look at the **[slides from the talk](https://github.com/kwf/GQFC/raw/master/Presentation.pptx)** (complete with *fancy animations* like below!).
